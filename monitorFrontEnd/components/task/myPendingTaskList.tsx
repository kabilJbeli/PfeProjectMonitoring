...
import {SafeAreaView, View, Text, FlatList, Dimensions, Pressable, StyleSheet} from "react-native";
...
const MyPendingTasksList = (props:any)=>{
	...
	const getClientTasks = (email: string) => {
		...
		axios({
			method: 'GET',
			url: `${Environment.API_URL}/api/task/getSpecificClientPendingTasks?clientEmail=${email}`,
			headers: {
				'Content-Type': 'application/json',
				useQueryString: false,
			},
