...
const PreviousSprintList = (props: any) => {
	...
	const filterSprint = (projectTitle: string) => {
		if(projectTitle === 'ALL'){
			...
			const filteredSprints = mainSprints.previousSprints.filter((item:any) => item.project.projectTitle == projectTitle);

			const constructedSprint ={
				currentSprints:mainSprints.currentSprints,
				previousSprints:filteredSprints
			}
...
export default PreviousSprintList;
