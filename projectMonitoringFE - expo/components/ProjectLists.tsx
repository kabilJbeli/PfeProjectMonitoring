...
import getWsProjects from "../redux/actions/action";
...
const _ProjectsList = (props) => {
    const [projectsS, setProjects] = useState<Project[]>([]);
    const [loading, setLoading] = useState(true);

    const {projectReducer,getWsProjects} = props;
...
console.log(projects);
    ...
    return (
        <View>
         <Text>JSON:  {JSON.stringify(projects)}</Text>
            {projects !== undefined &&
...
const ProjectsList = connect(mapStateToProps,{getWsProjects})(_ProjectsList);
